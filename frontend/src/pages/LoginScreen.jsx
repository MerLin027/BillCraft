...
export default function LoginScreen() {
  ...
  const { login, loginWithGoogle, intendedDestination, setIntendedDestination } = useApp()
    ...
    <div className="bg-[#0a0a0a] h-screen overflow-hidden">
      ...
      <div className="flex flex-col lg:flex-row h-full w-full overflow-hidden">
        ...
        <div className="relative hidden lg:flex w-full lg:w-[45%] xl:w-[40%] flex-col justify-between p-8 xl:p-12 overflow-hidden bg-[#1a1a1a] border-r border-[#2a2a2a]">
          ...
          {/* Panel header — logo from SplashScreen.jsx, scaled down */}
        ...
        >
          ...
          {/* Card */}
          <div className="w-full max-w-[440px] flex flex-col gap-8 p-8">

            {/* Heading */}
            <div className="flex flex-col gap-2 text-center">
              <h1 className="text-3xl font-bold tracking-tight text-[#f5f5f5]">Welcome Back</h1>
            ...
            <form className="flex flex-col gap-5" onSubmit={handleLogin}>
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between">
                  ...
                  <button
                    type="button"
                    className="text-sm font-semibold text-[#22c55e] hover:text-[#22c55e]/80 transition-colors"
                  >
                    Forgot password?
                  </button>
                </div>
